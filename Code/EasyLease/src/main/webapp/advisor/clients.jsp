...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/advisor/clients.css"/>
</head>
<body>
    ...
    <div class="col-auto table-responsive shadow">
      <table class="table table-bordered caption-top">
        ...
        <tr>
          ...
          %>
          <td>
            <button type="button" class="btn btn-outline-primary" id="<%=client.getIdUser()%>">
              <a href="HistoryAdvisorClientServlet?id_client=<%=client.getIdUser()%>">Visualizza</a>
            </button>
          </td>
          <%
          }else {

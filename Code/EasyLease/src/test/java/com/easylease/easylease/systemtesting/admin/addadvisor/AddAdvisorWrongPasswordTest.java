 ...
 * but the password is not filled in correctly.
 *
 * @version 0.1
 * @author Sarro Antonio
 */
public class AddAdvisorWrongPasswordTest {
  ...
  @Test
  @DisplayName("ST_ADMIN_3_08")
  public void testAddAdvisorWrongPassword() throws Exception {
    ...
    driver.findElement(By.id("advisor_password")).sendKeys("ciao99");

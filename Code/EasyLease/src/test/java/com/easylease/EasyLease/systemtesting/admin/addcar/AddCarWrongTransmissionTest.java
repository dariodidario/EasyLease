...
public class AddCarWrongTransmissionTest {
  ...
  @Test
  @DisplayName("ST_ADMIN_1_23")
  public void testAddCarWrongTransmission() {
    ...
    driver.findElement(By.id("transmission")).sendKeys("656789");

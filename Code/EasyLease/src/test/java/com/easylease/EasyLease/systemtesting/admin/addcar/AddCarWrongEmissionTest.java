 ...
 * entered for "Emission".
 *
 * @version 0.1
 * @author Sarro Antonio
 */
public class AddCarWrongEmissionTest {
  ...
  @Test
  @DisplayName("ST_ADMIN_1_18")
  public void testAddCarWrongEmission() {
    ...
    driver.findElement(By.id("emission_class")).sendKeys("@");
    ...
    driver.findElement(By.id("power_supply")).sendKeys("0");

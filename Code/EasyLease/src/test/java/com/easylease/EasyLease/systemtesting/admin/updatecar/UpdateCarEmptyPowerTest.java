 ...
 */
public class UpdateCarEmptyPowerTest {
  ...
  @Test
  @DisplayName("ST_ADMIN_2_07")
  public void testUpdateCarEmptyPower() {
    ...
    driver.findElement(By.xpath("//img[@onclick=\"confirm('power_supply')\"]")).click();

...
public class AddCarEmptyBrandTest {
  ...
  public void testAddCarSuccess() {
    ...
    driver.findElement(By.id("avg_consumption")).sendKeys("6");
    ...
    driver.findElement(By.xpath("//div[@id='header']/nav/div/ul/li[3]/a/span")).click();

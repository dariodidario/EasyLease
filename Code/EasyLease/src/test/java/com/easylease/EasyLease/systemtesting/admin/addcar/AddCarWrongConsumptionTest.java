 ...
 */
public class AddCarWrongConsumptionTest {
  ...
  @Test
  @DisplayName("ST_ADMIN_1_13")
  public void testAddCarWrongConsumption() {
    ...
    driver.findElement(By.id("avg_consumption")).sendKeys("-1");

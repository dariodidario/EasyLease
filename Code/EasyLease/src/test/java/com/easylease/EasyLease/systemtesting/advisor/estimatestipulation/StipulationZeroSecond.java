 ...
 * having a 0 value of the second field.
 *
 * @author Caprio Mattia
 * @since 0.1
 * @version 0.2
 */
public class StipulationZeroSecond {
  ...
  @Test
  @DisplayName("ST_ADVISOR_2_06")
  public void testStipulationZeroSecond() throws Exception {
    ...
    driver.findElement(By.id("Assicurazione furto")).sendKeys("0");

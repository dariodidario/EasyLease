...
public class RegistrationPasswordNoDigitsTest {
  ...
  @Test
  @DisplayName("ST_NRUSER_1_19")
  public void testRegistrationPasswordNoDigits() throws Exception {
    ...
    driver.findElement(By.id("conferma")).sendKeys("Password");

 ...
 * but the e-mail is not filled in correctly.
 *
 * @version 0.1
 * @author Sarro Antonio
 */
public class AddAdvisorWrongEmailTest {
  ...
  @Test
  @DisplayName("ST_ADMIN_3_06")
  public void testAddAdvisorWrongEmail() throws Exception {

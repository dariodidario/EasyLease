...
public class AddCarSuccessTest {
  ...
  public void testAddCarSuccess() throws Exception {
    ...
    driver.findElement(By.xpath("//div[@id='container']/form/table/tbody/tr[3]/td[2]")).click();
    ...
    driver.findElement(By.id("image_path")).sendKeys("C:\\Users\\sarro\\Desktop\\EasyLease\\Code\\EasyLease\\src\\test\\java\\com\\easylease\\EasyLease\\systemtesting\\admin\\giulietta.jpg");

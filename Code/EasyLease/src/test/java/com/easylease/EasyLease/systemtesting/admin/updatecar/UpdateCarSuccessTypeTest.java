 ...
 */
public class UpdateCarSuccessTypeTest {
  ...
  @Test
  @DisplayName("ST_ADMIN_2_04")
  public void testUpdateCarSuccessType() {
    ...
    driver.findElement(By.xpath("//input[@type='text']")).sendKeys("Berlina");

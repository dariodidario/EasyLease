...
class EstimateManagementClientServletTest {
  ...
  @Test
  void estimateManagementClientServletTest_Success()
  ...
  @Test
  void estimateManagementClientServletTest_WrongUser_ExceptionThrown()
      throws ServletException, IOException {
  ...
  @Test
  void estimateManagementClientServletTest_WrongId_ExceptionThrown()
      throws ServletException, IOException {
    Client client = clientDao.retrieveById("CLEE8BD");
    when(session.getAttribute("user")).thenReturn(client);
  ...
  @Test
  void estimateManagementClientServletTest_ShortId_ExceptionThrown()
      throws ServletException, IOException {
    Client client = clientDao.retrieveById("CLEE8BD");
    when(session.getAttribute("user")).thenReturn(client);

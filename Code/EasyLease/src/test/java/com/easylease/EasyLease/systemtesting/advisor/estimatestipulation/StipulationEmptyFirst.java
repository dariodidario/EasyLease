 ...
 * without entered the value of the first field.
 *
 * @author Caprio Mattia
 * @since 0.1
 * @version 0.2
 */
public class StipulationEmptyFirst {
  ...
  @Test
  @DisplayName("ST_ADVISOR_2_01")
  public void testStipulationEmptyFirst() throws Exception {

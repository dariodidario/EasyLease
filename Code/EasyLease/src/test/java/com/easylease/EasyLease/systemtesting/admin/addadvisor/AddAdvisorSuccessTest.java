...
public class AddAdvisorSuccessTest {
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    driver.findElement(By.id("advisor_name")).sendKeys("Angela");
    driver.findElement(By.id("advisor_surname")).click();
    driver.findElement(By.id("advisor_surname")).clear();
    driver.findElement(By.id("advisor_surname")).sendKeys("Rossi");
    ...
    /* ROLLBACK */
    advisorDAO.delete(advisorDAO.retrieveByEmail("angelarossi@gmail.com"));
  }

 ...
 */
public class UpdateCarSuccessPowerTest {
  ...
  @Test
  @DisplayName("ST_ADMIN_2_08")
  public void testUpdateCarSuccessPower() {
    ...
    driver.findElement(By.id("matita_power_supply")).click();
    driver.findElement(By.xpath("//input[@type='text']")).click();
    driver.findElement(By.xpath("//input[@type='text']")).clear();
    driver.findElement(By.xpath("//input[@type='text']")).sendKeys("Diesel");

...
public class DBCarDAO implements CarDAO{
    ...
    public synchronized Car retriveById(String id) throws SQLException {
        ...
        try { //set up of the connection with db
            ...
            if(rs!=null){//extraction of the data from the db
                ...
                car.setDoors(rs.getInt("PORTE"));
                car.setChanging(rs.getString("CAMBIO"));
                car.setAverage_consumption(rs.getDouble("CONSUMO_MEDIO"));
                car.setHorses(rs.getInt("CAVALLI"));
                car.setCO2(rs.getString("CO2"));
                car.setEmissions(rs.getDouble("EMISSIONI"));
                car.setPowerSupply(rs.getString("POWER_SUPPLY"));
                car.setCapacity(rs.getDouble("CILINDRATA"));
                car.setOptional_serie(rs.getString("OPTIONAL_SERIE"));
    ...
    public synchronized void update(Car car) throws SQLException {
        ...
        String deleteSQL = "UPDATE " + DBCarDAO.TABLE_NAME + "SET ID = ?, BRAND = ?, MODEL = ?, PRICE = ?, CAR_TYPE = ?, VISIBILITY = ?, PORTE = ?, CAMBIO = ?, CONSUMO_MEDIO = ?, CAVALLI = ?, CO2 = ?, EMISSIONI = ?, POWER_SUPPLY = ?, CILINDRATA = ?, OPTIONAL_SERIE = ?, IMAGE = ? WHERE ID = ?";
        ...
        try {//set up of the connection with the database
            ...
            preparedStatement.setString(8, car.getChanging());
            preparedStatement.setDouble(9, car.getAverage_consumption());
            preparedStatement.setInt(10, car.getHorses());
            preparedStatement.setString(11, car.getCO2());
            preparedStatement.setDouble(12, car.getEmissions());
            preparedStatement.setString(13, car.getPowerSupply());
            preparedStatement.setDouble(14, car.getCapacity());
            preparedStatement.setString(15, car.getOptional_serie());
            preparedStatement.setString(16, car.getImage());
            preparedStatement.setString(17, car.getId());
    ...
    public synchronized void insert(Car car) throws SQLException {
        ...
        String insertSQL = "INSERT INTO " + DBCarDAO.TABLE_NAME
                + " (ID, BRAND, MODEL, PRICE, CAR_TYPE, VISIBILITY, PORTE, CAMBIO, CONSUMO_MEDIO, CAVALLI, CO2, EMISSIONI, POWER_SUPPLY, CILINDRATA, OPTIONAL_SERIE, IMAGE) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";//query sql for the insert
